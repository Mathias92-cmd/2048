...
public class JeuApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("jeu2048-view.fxml"));
        Parent viewContent = fxmlLoader.load();

        // Ensuite, on la place dans une Scene...
        Scene scene = new Scene(viewContent); //Si on mes rien sa calcule est fait le responsive (en gros) tt seul
